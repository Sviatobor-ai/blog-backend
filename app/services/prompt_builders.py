...
def build_generation_brief_topic(
    *, topic: str, rubric_name: str, keywords: Iterable[str] | None, guidance: str | None
) -> str:
...
def build_generation_brief_transcript(
    *, transcript_text: str, rubric_name: str | None, keywords: Iterable[str] | None, guidance: str | None
) -> str:
